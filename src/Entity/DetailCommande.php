...
class DetailCommande
{
    ...
    #[ORM\ManyToOne(targetEntity: Commande::class, inversedBy: 'detailCommande', cascade: ['persist', 'remove'])]
    private $commande;

    #[ORM\ManyToOne(targetEntity: Produit::class, inversedBy: 'detailCommande', cascade: ['persist', 'remove'])]
    private $produit;
